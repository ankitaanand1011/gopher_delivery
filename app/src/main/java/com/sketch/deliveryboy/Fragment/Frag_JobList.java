...
import com.sketch.deliveryboy.Adapter.AdapterJobList;
...
public class Frag_JobList extends Fragment {
    ...
    ProgressDialog pd;
    AdapterJobList adapterJobList;



    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_job_list, container, false);
        ...
        arr_order_job_list = new ArrayList<>();

        rv_job_list = view.findViewById(R.id.rv_job_list);
                ...
                try {
                    ...
                    if(status.equals("1")) {
                        ...
                        if(status.equals("1")) {
                            ...
                            Log.d(TAG, "onResponse: p_arr:  " + arr_order_job_list);
                            adapterJobList = new AdapterJobList(getActivity(), arr_order_job_list);
                            rv_job_list.setAdapter(adapterJobList);
