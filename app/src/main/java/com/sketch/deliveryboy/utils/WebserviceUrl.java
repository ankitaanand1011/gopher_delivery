package com.sketch.deliveryboy.utils;
...
public class WebserviceUrl {
   ...
   // private static String SiteName = "http://apistore.mycartface.com/api/";
    private static String SiteName = "http://lab-3.sketchdemos.com/P1117_Gropher_App/Deliveryboy/";
    ...
    public static String order_accepted = SiteName +"order_accepted";
    public static String earning_list = SiteName +"earning_list";
